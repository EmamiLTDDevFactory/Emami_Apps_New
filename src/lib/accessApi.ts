// Talks to the hub-auth backend's Manage Access endpoints (backend/server.js,
// same Lambda as authApi.ts) which read/write emami_apps.authorized_users and
// emami_apps.authorized_user_apps in the dev Postgres database.
